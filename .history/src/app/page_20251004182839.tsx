...
export default function Home() {
  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen p-24">
      ...
      <p className="max-w-md mx-auto mt-3 text-base text-center text-gray-500 md:mt-5 md:text-lg md:max-w-xl">
      ...
      <div className="mt-8">
        {status === 'loading' ? (
          ...
          <div className="space-x-4">
            ...
            <Link
              href="/signup"
              className="px-8 py-3 font-medium text-indigo-700 bg-indigo-100 rounded-md hover:bg-indigo-200"
            >
              Sign Up
            </Link>
          </div>
